...
public class BinaryTreeUtilsTest {
    ...
    @Test
    void isBalancedTest() {
        BinaryTree<Integer> rootNode = BinaryTreeUtils.of(4, 2, 8, 1, 3, 7, 9);
    ...
    @Test
    void toStringTest() {
        BinaryTree<Integer> rootNode1 = BinaryTreeUtils.of(4);
        assertThat(BinaryTreeUtils.toString(rootNode1)).isEqualTo("4");

        BinaryTree<Integer> rootNode2 = BinaryTreeUtils.of(4, 2);
        assertThat(BinaryTreeUtils.toString(rootNode2)).isEqualTo("4, 2, null");

        BinaryTree<Integer> rootNode3 = BinaryTreeUtils.of(4, null, 8);
        assertThat(BinaryTreeUtils.toString(rootNode3)).isEqualTo("4, null, 8");

        BinaryTree<Integer> rootNode4 = BinaryTreeUtils.of(4, 2, 8);
        assertThat(BinaryTreeUtils.toString(rootNode4)).isEqualTo("4, 2, 8");

        BinaryTree<Integer> rootNode5 = BinaryTreeUtils.of(4, 2, 8, 1);
